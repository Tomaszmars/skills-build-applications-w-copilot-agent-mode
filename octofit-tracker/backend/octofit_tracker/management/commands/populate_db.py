...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        Workout.objects.create(name='Stealth', description='Silent movement and gadgets', user='batman')
        Workout.objects.create(name='Flight', description='Aerial maneuvers', user='superman')
